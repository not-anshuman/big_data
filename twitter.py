...
if bearer_token is None:
    raise ValueError("No bearer token found in environment variable BEARER_TOKEN")
...
class CustomStreamingClient(tweepy.StreamingClient):
    def __init__(self, *args, **kwargs):
        ...
        self.csv_writer.writerow(['id', 'screen_name', 'created_at', 'text'])  # Write header
    ...
    def on_tweet(self, tweet):
        ...
        if 'id' in tweet and 'text' in tweet:
            ...
            self.csv_writer.writerow([id, screen_name, created_at, text])  # Write row
        else:
